document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleDoorClick(event) {
        ...
        if (blockTrails < leftDoorArray.length) {
            ...
            experimentRecords.push({TrailNo:blockTrails+1,ChoosedBox:doorNumber === "2"?"Left":"Right",CueShowed:leftDoorArray[blockTrails]===1?"Left":"Right", RewardBox:leftDoorArray[blockTrails] ===1?"Left":"Right",Rewards: reward, ReactionTime: reactionTime / 100, BoxProb: boxProbability, CueProb: cueProbability });
